"""
Double DQN with Prioritized Experience Replay for CartPole-v1

Double DQN reduces overestimation bias by decoupling action selection and evaluation.
PER samples transitions based on their TD-error magnitude for more efficient learning.
